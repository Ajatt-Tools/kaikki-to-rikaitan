...
const indexJson = {
    ...
    url: 'https://github.com/Ajatt-Tools/kaikki-to-rikaitan',
    description: 'Dictionaries for various language pairs generated from Wiktionary data, via Kaikki and Kaikki-to-Rikaitan.',
...

{
    ...
    consoleOverwrite(`4-make-rikaitan.js: reading lemmas...`);
...

{
    ...
    consoleOverwrite('4-make-rikaitan.js: Processing forms...');
