/* Note: This file shouldn't be needed. */
const languages = []
const latestUrl = 'https://github.com/Ajatt-Tools/kaikki-to-rikaitan/releases/latest/download/'

async function fetchLanguages() {
    try {
        const response = await fetch('https://raw.githubusercontent.com/Ajatt-Tools/kaikki-to-rikaitan/refs/heads/master/languages.json')
        if (!response.ok) {
